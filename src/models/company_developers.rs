...
/// CompanyDevelopers : Company.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CompanyDevelopers {
    /// List of developers in a company.
    #[serde(rename = "developer", skip_serializing_if = "Option::is_none")]
    pub developer: Option<Vec<crate::models::CompanyDeveloper>>,
}

impl CompanyDevelopers {
    /// Company.
    pub fn new() -> CompanyDevelopers {
        CompanyDevelopers {
            developer: None,
        }
    }
