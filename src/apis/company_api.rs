...
pub async fn list_companies(configuration: &configuration::Configuration, org_name: &str, expand: Option<bool>, start_key: Option<String>, count: Option<String>) -> Result<crate::models::Companies, Error<ListCompaniesError>> {
